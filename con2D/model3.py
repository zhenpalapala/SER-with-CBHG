...
tf.app.flags.DEFINE_integer('num_epoch', 4000, 'The number of epoches for training.')
...
tf.app.flags.DEFINE_boolean  ('restore',True,'Set this to False to do a fresh training')
